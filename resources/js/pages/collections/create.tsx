...
export default function CreateCollection() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Sammlung erstellen" />

            <div className="p-4">
                <div className="flex items-center justify-between mb-4">
                    <HeadingSmall title="Sammlung erstellen" description="Erstelle eine neue Sammlung." />
                    ...
                    <CardContent>
                        <form onSubmit={submit} className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <FileUpload height="min-h-24" onChange={(file) => setData('thumbnail', file)} />
