...
export default function AddField({ onAddField, initial, open, onClose, children }: AddFieldProps) {
    ...
    useEffect(() => {
        if (initial) {
            ...
            setData('label', initial.label);
            setData('type', initial.type);
            setData('options', initial.options);
            setData('required', initial.required);
        }
    }, [open, initial, setData]);
    ...
    return (
        <Dialog open={open}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>
                        {initial ? 'Feld bearbeiten' : 'Neues Feld hinzufügen'}
                    </DialogTitle>
                </DialogHeader>
                ...
                <div className="grid gap-4">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center gap-2">
                            <Switch checked={data.required} onClick={() => setData('required', !data.required)} id="required" />
